...
"""The fabric script here also generates a .tgz archive from the contents of the
...
env.hosts = ["web-01.peterkwesiobrempongstephenson.tech", "web-02.peterkwesiobrempongstephenson.tech"]
env.user = "ubuntu"
