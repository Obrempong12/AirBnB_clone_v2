# The script here configures web servers for deployment
...
# creates link for current release
ln -sf /data/web_static/releases/test /data/web_static/current

# allows user to have permissions over directories
chown -R ubuntu:ubuntu /data

# updates nginx configuration to add alias configuration
